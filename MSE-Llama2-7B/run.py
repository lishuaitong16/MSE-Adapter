...
def parse_args():
    ...
    parser.add_argument('--res_save_dir', type=str, default='results/results_reg',
                        help='path to save results.')
    parser.add_argument('--pretrain_LM', type=str, default='/data/lishuaitong/model/Llama-2-7b-chat-hf',
