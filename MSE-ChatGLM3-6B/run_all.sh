...
nohup python run.py --task_type regression --gpu_ids 3 > logs/run_regression.log 2>&1 &
echo "Regression PID: $!"

echo "Starting classification (meld, cherma) on GPU 2..."
nohup python run.py --task_type classification --gpu_ids 2 > logs/run_classification.log 2>&1 &
