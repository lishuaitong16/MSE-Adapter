...
完整对比见 [RESULTS.md](RESULTS.md)。**复现**为对原论文生成式方法的复现，**改进**为本项目新增的判别式变体（回归头 / 分类头）。

### 回归任务（MAE ↓ / Corr ↑）

| 骨干模型 | 版本 | MOSEI MAE ↓ | MOSEI Corr ↑ | SIMSV2 MAE ↓ | SIMSV2 Corr ↑ |
|---------|------|------------|-------------|-------------|--------------|
| Qwen-1.8B | 复现 | 59.34 | 69.59 | 33.04 | 64.74 |
| Qwen-1.8B | **改进** | **50.78** | **79.92** | **31.51** | **70.63** |
| Llama2-7B | 复现 | 51.94 | 77.30 | 36.45 | 58.62 |
| Llama2-7B | **改进** | **49.18** | **80.92** | **31.56** | **70.15** |
| ChatGLM3-6B | 复现 | 51.84 | 78.53 | **30.54** | 70.17 |
| ChatGLM3-6B | **改进** | **49.63** | **80.98** | 31.64 | **70.74** |

### 分类任务（Weighted-F1 ↑）

| 骨干模型 | 版本 | MELD W-F1 ↑ | CHERMA W-F1 ↑ |
|---------|------|------------|--------------|
| Qwen-1.8B | 复现 | 62.17 | 71.93 |
| Qwen-1.8B | **改进** | **62.70** | **72.65** |
| Llama2-7B | 复现 | 63.54 | **72.66** |
| Llama2-7B | **改进** | **65.58** | 72.43 |
| ChatGLM3-6B | 复现 | 60.21 | **72.85** |
| ChatGLM3-6B | **改进** | **61.82** | 68.80 |
